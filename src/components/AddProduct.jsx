            ...
            <form  >
                <div className='flex flex-col md:flex md:flex-row gap-4 mb-4'>
                    ...
                    <div className='w-full md:w-[50%] flex flex-col'>
                        ...
                        <input type='text' placeholder='Type product name' {...register("product_name")} className='bg-gray-300 py-2 px-2' />
                    </div>
                </div>
                <div>
                    <div className='w-full  flex flex-col mb-4'>
                        <label className='flex w-full justify-between'>Only visible to authorized personnel <FaRegEyeSlash /></label>
                        <input type='password' {...register("password")} placeholder='******' className='bg-gray-300 py-2 ' />
                    </div>
                    <div className='w-full  flex flex-col '>
                        <input type='btn' placeholder='upload 2 to 4 images' className='bg-gray-200 mt-4 py-2 placeholder:text-center' />
                    </div>
                </div>
                <div className='w-full flex flex-col md:flex md:flex-row md:justify-end gap-4 mt-4'>
                    <select
                    {...register("brand_name")}
                        className='shadow bg-pink-200 appearance-none border h-12 rounded w-full md:w-[50%] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'
                        required
                    >
                    ...
                    <div className='w-full md:w-[50%] flex items-center flex-col'>
                        ...
                        <p className='text-xs w-[80%] pl-4'>Please note:You can only select one color per product,if the product has multiple color,you need to add a new product with same product code</p>
                        </div>
                    </div>
                </div>
                <div className='w-full  flex flex-col'>
                    <label className='flex w-full justify-between'>Description</label>
                    <input type='text' {...register("product_description")}  placeholder='Type product description' className='bg-gray-300 py-2  px-2 ' />
                </div>
                <div className='w-full  flex flex-col'>
                ...
                <div className='w-full  flex flex-col'>
                    ...
                    <input type='text' {...register("composition")} placeholder='Type Composition description' className='bg-gray-300 py-2 ' />
                </div>
                <div className='w-full  flex flex-col'>
                    <label className='flex w-full justify-between'>Fit</label>
                    <input type='text' {...register("fit")} placeholder='fit' className='bg-gray-300 py-2 ' />
                </div>
                <div className='w-full  flex flex-col md:flex md:items-start md:flex-row gap-4 mt-4 '>
                    ...
                    <div className='w-full  md:w-[50%] flex flex-col'>
                        ...
                        <input type='number' {...register("items_number")} placeholder='Type item number' className='w-full bg-gray-300 py-2 px-2' />
                ...
                <div className='md:w-full  flex flex-col md:flex md:items-start md:flex-row gap-4 mt-4 '>
                    ...
                    <button className='bg-[#6c6d70] py-2 px-2 rounded-sm text-white md:w-[50%]'> + Add to Category</button>
                </div>
                ...
                <div className='flex flex-col md:flex md:flex-row gap-4 mb-4 mt-4'>
                    <div className='w-full md:w-3/5 flex flex-col '>
                        ...
                        <input type='number' placeholder='Type product ID' className='w-full bg-gray-300 py-2 px-2' />
                    </div>
                ...
                <div className='flex flex-col md:flex md:flex-row gap-4 mb-4 mt-4'>
                    <div className='w-full md:w-3/5 flex flex-col '>
                        ...
                        <input type='number' placeholder='Type Keyword' className='w-full bg-gray-300 py-2 px-2' />
                    </div>
                    <div className='w-full md:w-2/5 flex flex-col'>
                        <label></label>
                        <button className='bg-[#6c6d70] mt-6 py-2 px-2 rounded-sm text-white '> + Add keyword</button>
                    </div>
                </div>
                ...
                <div className='flex flex-col md:flex-row items-center gap-2 mt-4'>
                    ...
                    <label>Show low stock message</label>
                       <Switcher1 switchLeftLabel={"OFF"} switchRightLabel={"ON"}/>
                    </div>
                    <p className='text-xs'>Please note:sizes will be displayed as low stock when there are 2 or less items in that size</p>
                </div>
                <div className="w-full mt-4  md:flex-row items-center mx-auto  md:w-[60%] justify-center flex gap-4">
                <button type='button'  onClick={() => handleSubmit(saveProductHandler)()} className='bg-[#6c6d70]  py-2 px-2 rounded-sm text-white '>Save Product</button>
                <button type='button'  className='bg-[#6ba466] py-2 px-2 rounded-sm text-white'>Publish Product</button>
                </div>
