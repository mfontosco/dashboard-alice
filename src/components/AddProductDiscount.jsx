    ...
    <div>
      ...
      <div className='flex flex-col md:flex md:flex-row gap-4 mb-4'>
                    <div className='w-full md:w-[50%] flex flex-col '>
                        ...
                        <input type='number' placeholder='Type discount code' {...register("discount_code")} className='w-full bg-gray-300 py-2 px-2' />
                    </div>
                    <div className='w-full md:w-[50%] flex flex-col'>
                ...
                <div className='flex gap-4 md:flex-row flex-col'>
                    <div className='w-full  md:w-1/2   flex flex-col md:mb-4'>
                        ...
                        <input type='text' {...register("product_id")} placeholder='Type product ID' className='bg-gray-300 py-2 px-2 ' />
                    </div>
                ...
                <div className='flex flex-col md:flex md:flex-row gap-4 mb-4 mt-4'>
                    <div className='w-full md:w-[50%] flex flex-col '>
                        ...
                        <input type='date' placeholder='Type  code' {...register("start_date")}className='px-2 w-full bg-gray-300 py-2' />
                    </div>
                    <div className='w-full md:w-[50%] flex flex-col'>
                        <label>Start Time</label>
                        <input type='time' value='00:00' {...register("start_time")} className='px-2 bg-gray-300 py-2 w-36 px-2' />
                    </div>
                </div>
                <div className='flex flex-col md:flex md:flex-row gap-4 mb-4 mt-4 md:mt-6'>
                    <div className='w-full md:w-[50%] flex flex-col '>
                        <label>End Date</label>
                        <input type='date' placeholder='Type  code' {...register("end_date")} className='px-2 w-full bg-gray-300 py-2' />
                    </div>
                    <div className='w-full md:w-[50%] flex flex-col'>
                ...
                <button type='submit' className='bg-[#6ba466] py-2 px-4 rounded-sm text-sm text-white'>Run at Start Time</button>
                </div>
      </form>
    </div>
  );
