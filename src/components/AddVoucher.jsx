    ...
    <div>
      ...
      <div className='flex flex-col md:flex md:flex-row gap-4 mb-4'>
                    <div className='w-full md:w-[50%] flex flex-col '>
                        ...
                        <input type='number' placeholder='Type  code' {...register("voucher_code")} className='w-full bg-gray-300 py-2 px-2' />
                    </div>
                    <div className='w-full md:w-[50%] flex flex-col'>
                        <label>Amount</label>
                        <input type='text' {...register("amount")} placeholder='Type amount in naira' className='bg-gray-300 py-2 px-2' />
                    </div>
                </div>
                ...
                <div className='flex flex-col md:flex md:flex-row gap-4 mb-4 mt-4'>
                    <div className='w-full md:w-[50%] flex flex-col '>
                        ...
                        <input type='date' placeholder='Type  code' {...register("end_date")} className='w-full bg-gray-300 py-2 px-2' />
                    </div>
                    <div className='w-full md:w-[50%] flex flex-col'>
                ...
                <button  type="submit" className='bg-[#6ba466] py-2 px-4 rounded-sm text-white'>Publish Voucher</button>
                </div>
      </form>
    </div>
  );
